...
private:
    PathfindingLib::MovementType movementType_;
...
public:
     ...
     */
    PathfindingLib::MovementType getMovementType() const noexcept { return movementType_; }

    /**
     * @brief Set movement type
     */
    void setMovementType(PathfindingLib::MovementType moveType) noexcept { movementType_ = moveType; }
    ...
    std::vector<std::tuple<CoordType, CoordType>> getNeighbors(CoordType x, CoordType y) const
    {
        ...
        neighbors.reserve(movementType_ == PathfindingLib::MovementType::EightWay ? 8 : 4);
        ...
        if (movementType_ == PathfindingLib::MovementType::EightWay)
        {
